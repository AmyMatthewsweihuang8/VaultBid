      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <h1 className="text-6xl md:text-7xl font-bold leading-tight">
            <span className="text-gradient">Private NFT Auctions</span>
            <br />
            <span className="text-foreground">Where Bids Stay Secret</span>
          </h1>

          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Bid on exclusive digital collectibles with complete privacy. All bids remain encrypted on-chain until the auction ends, powered by Zama's FHE technology.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <Button
              size="lg"
              className="bg-gradient-cyber hover:opacity-90 text-background font-semibold px-8 shadow-glow-cyan"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-16">
            <div className="p-6 rounded-xl bg-gradient-card border border-border/50 hover:border-neon-cyan/50 transition-all">
              ...
              <p className="text-sm text-muted-foreground">Bids encrypted with Zama FHE technology</p>
            </div>
            <div className="p-6 rounded-xl bg-gradient-card border border-border/50 hover:border-neon-purple/50 transition-all">
              ...
              <p className="text-sm text-muted-foreground">On-chain verification after auction ends</p>
            </div>
            <div className="p-6 rounded-xl bg-gradient-card border border-border/50 hover:border-neon-pink/50 transition-all">
              ...
              <p className="text-sm text-muted-foreground">Instant bid processing on-chain</p>
            </div>
          </div>
        </div>
      </div>
